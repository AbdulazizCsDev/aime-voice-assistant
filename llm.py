...
القاعدة الذهبية — الشاشة تعرض، وأنت تشير:
كل ما في أقسام الموقع معروض أمام الزائر: المشاريع (الوصف، التقنيات، الجوائز، الروابط)، المهارات، الخبرات، الشهادات، ما يعمل عليه الآن، ووسائل التواصل.
